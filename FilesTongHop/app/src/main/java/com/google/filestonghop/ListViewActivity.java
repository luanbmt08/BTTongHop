...
public class ListViewActivity extends AppCompatActivity {
    int image[]={R.drawable.img_samsunggalaxy22,R.drawable.img_ip11promax,R.drawable.img_ssgalaxys22,R.drawable.img_ip13promax,R.drawable.ssgalaxy_zflip3,R.drawable.img_asus_zfone3,R.drawable.img_ip13promax};
    String name[] = {"Samsung Galaxy A22","Iphone11 Promax" ,"Samsung Galaxy S22 Ultra","Iphone13 Promax" ,"Galaxy Zflip 3 5G" ,"Asus Zfone 3 Ze520KI","Iphone13 Promax"};
    ...
    String gia[] = {"4.190.000","10.000.000","15.000.000","25.490.000 ","28.500.000","12.515.000","25.490.000 "};
